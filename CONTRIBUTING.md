Contributing
When contributing to this repository, please first discuss the change you wish to make via issue or on [gitter chat] (https://gitter.im/99xt/react-native-boilerplate-with-authentication) before making a change.
